...
using FreshShop.Areas.Identity.Models.ManageViewModels;
using FreshShop.Areas.Identity.Models.RoleViewModels;
using FreshShop.Areas.Identity.Models.UserViewModels;
using FreshShop.Data;
using FreshShop.ExtendMethods;
...
namespace FreshShop.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, DataContext context, UserManager<AppUserModel> userManager)
        {
            _logger = logger;
