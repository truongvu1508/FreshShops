...
namespace FreshShop.Controllers
{
    ...
    public class UserInforController : Controller
    {
        ...
        ILogger<UserInforController> logger)
        {
        ...
        public IActionResult LinkLogin(string provider)
        {
            ...
            var redirectUrl = Url.Action("LinkLoginCallback", "UserInfor");
        ...
        public async Task<IActionResult> EnableTwoFactorAuthentication()
        {
            ...
            return RedirectToAction(nameof(Index), "UserInfor");
        }
